...
export default function LandingPage() {
  return (
    <main className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-orange-500 via-orange-500 to-orange-500 text-white px-4 sm:px-6 md:px-8 py-16 overflow-hidden relative">
      {/* Background blobs */}
